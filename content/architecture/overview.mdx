...
DojOps is designed as a modular, layered DevOps agent system — not a simple chatbot that generates bash commands. It is a structured, safe, extensible orchestration framework with 13 built-in DevOps modules, a custom module system for extending with additional modules, 17 specialist agents, sandboxed execution, approval workflows, and hash-chained audit trails.
