...
# Start the MCP server in another (connects to the API on port 3000)
dojops serve --mcp
```
...
See the [MCP reference](/components/mcp#dojops-as-mcp-server) for configuration examples for Claude Code, Gemini CLI, and GitHub Copilot.

---

## Next steps

- [MCP reference](/components/mcp) — Config format, transport details, MCP server setup
