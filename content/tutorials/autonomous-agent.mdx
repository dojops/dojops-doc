...
The `run_skill` tool gives the agent access to all 18 built-in DojOps skills. The agent discovers what's needed, then delegates to the right skill with the right parameters.
...
| `run_skill`    | Run one of the 18 built-in DojOps skills with custom context     |
