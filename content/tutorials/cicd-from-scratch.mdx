...
```
ID         Type      Skill                      Status     Date
init-001   init      project-scanner            completed  2026-03-20 10:00
plan-001   plan      planner                    completed  2026-03-20 10:05
exec-001   execute   github-actions             completed  2026-03-20 10:06
exec-002   execute   dockerfile                 completed  2026-03-20 10:06
exec-003   execute   docker-compose             completed  2026-03-20 10:07
check-001  check     quality-analyst            completed  2026-03-20 10:09
```
...
The planner couldn't map your goal to any of the 18 built-in skills. Be more specific: include the tool names explicitly (e.g., "GitHub Actions" instead of "CI/CD"). Run `dojops skills list` to see what's available.
