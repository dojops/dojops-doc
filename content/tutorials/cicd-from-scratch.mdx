...
The planner couldn't map your goal to any of the 35 built-in skills. Be more specific: include the tool names explicitly (e.g., "GitHub Actions" instead of "CI/CD"). Run `dojops skills list` to see what's available.
