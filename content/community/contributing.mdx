...
packages/
  ...
  runtime/          18 built-in DevOps skills as .dops files (DopsRuntime)
...
All 18 built-in skills are `.dops` files in `packages/runtime/skills/`. To add a new built-in skill, create a `.dops` file following the format. See [DevOps Skills](/components/skills) for the full pattern.
