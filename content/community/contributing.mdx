...
4. **Validate** the tool:
   ...
   ```bash
   dojops modules validate .dojops/tools/my-tool/
   ```
...
Custom tools are automatically discovered and available to the Planner, Executor, and API. See [DevOps Tools — Custom Tool System](/components/tools#custom-tool-system) for the full manifest format.
