...
All 12 built-in tools are `.dops v2` module files in `packages/runtime/modules/`. To add a new built-in tool, create a `.dops` file following the v2 format. See [DevOps Tools](/components/tools) for the full pattern.
