...
DojOps includes 17 built-in specialist agents for keyword-based prompt routing, plus support for user-defined custom agents. Each agent has a domain-specific system prompt, keyword set, and optional tool dependencies.
